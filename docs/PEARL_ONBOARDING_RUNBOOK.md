...
> Current customer onboarding follows the login-first, NamedCoin-first, birth-bound
> MSB product canon in agentchat. This control-plane runbook does not authorize
> customer-path shortcuts, Store state edits, or side-loaded apps. Releases use
> the governed provider and rendered Store/Admin controls, followed by Upgrade
> Pearls and fresh-launch verification.
