...
def test_checked_in_default_bazaar_catalog_is_complete_and_release_gated():
    ...
    assert claude["source_commit"] == "715d5c2b2f95d5d45c14e186fa2f4cab0d56db64", claude
    ...
    assert telescreen["source_commit"] == "94c3dd5f920a7d9a7c8a904547f69fbe751bc589", telescreen
    ...
    assert instadao["source_commit"] == "28506f58358e1017223f9fc5335c49840474678c", instadao
    ...
    assert ai_lagoon["source_commit"] == "007156239f1bfdcabed978dcf4180ab909f8cd17", ai_lagoon
...
def test_checked_in_catalog_preserves_source_and_slot_evidence():
    ...
    assert ailagoon["source_commit"] == "007156239f1bfdcabed978dcf4180ab909f8cd17", ailagoon
