...
func TestRefusalNamesAreDistinctAndParsable(t *testing.T) {
	names := []string{
		...
		RefusalStoreEnrollmentTimeInvalid, RefusalStoreEnrollmentNotYetValid,
		RefusalStoreEnrollmentExpired, RefusalStoreEnrollmentProfileMismatch,
		RefusalStoreEnrollmentSignaturesInsufficient, RefusalStoreEnrollmentSignatureInvalid,
		RefusalStoreEnrollmentFactsMismatch, RefusalStoreRPCGenesisMismatch,
