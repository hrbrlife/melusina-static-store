...
// Client is the preparer-side half of the constrained local signer protocol.
...
// CheckSocket lets supervised preparer startup verify the same fixed local
...
// preparer still validates all returned facts before it produces a result.
