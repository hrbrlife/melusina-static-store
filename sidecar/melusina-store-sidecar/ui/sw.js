// v4 deliberately evicts the stale v3 shell that could cache the old
// pre-sidecar entry bundle. App/catalog/update paths remain network-only.
const CACHE_NAME = 'melusina-market-v4';
